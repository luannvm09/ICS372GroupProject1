...
/**
 * This class is used for returning many of the results of the grocery system's
 * business logic to user interface.
 *
 * the Result object returns an int code, plus values of selected fields
 * of Product and Member. They are the product name, id, stockOnHand member name, phone, id, address.
 */
